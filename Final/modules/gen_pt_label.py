...
OUTPUT_DIR = 'pyg_data_DistilBERT_ransomware2025'
...
GRAPH_VOCAB_JSON = "artifacts/graph_vocab.json"
...
def graphml_to_pyg_data(path):
    try:
        ...
        data_out = Data(
            ...
            edge_index=edge_idx,
            y=y,
            node_ids=torch.tensor(node_ids, dtype=torch.long),  # ✅ quan trọng
...
if __name__ == '__main__':
    batch_convert(
        os.getenv('GRAPHML_DIR', 'graph_ransomware2025_reports'),
        ['ransomware']
    )