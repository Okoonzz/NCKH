...
def build_ransomware_graph(report_path: str) -> nx.DiGraph:
    ...
    # 3) API call nodes
    api_nodes = []
    api_sequence = report.get('api_call_sequence', [])[:1000]  # Limit to first 1000 calls for performance
...
def batch_build_graphs_multithread(
    reports_dir='feature/ransomware',
    out_dir='graph_1000_api/ransomware',
    max_workers=None
):
    """
